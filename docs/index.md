...
features:
  ...
  - title: Go from 4 sessions to 15
    details: Most people manually open a few Claude Code sessions. With Agent Herder, Claude handles the session management — so you scale to 10, 15 parallel sessions without the overhead.
